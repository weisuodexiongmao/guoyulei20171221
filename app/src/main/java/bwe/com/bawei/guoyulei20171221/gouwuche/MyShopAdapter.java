...
public class MyShopAdapter extends BaseExpandableListAdapter {
    ...
    Gouwu_Activity mainActivity;

    public MyShopAdapter(Context context, ArrayList<GroupBean> groupBeen, ArrayList<ArrayList<GoodsBean>> goods, Gouwu_Activity mainActivity) {
